...
- 邮箱：policy@xiaoyao.com
    ...
    const project = await prisma.startupProject.create({
      data: {
        ...
        industry: '人工智能',
        stage: '成长期',
        fundingAmount: 5000000, // 500万
        teamSize: 15,
        location: '北京市海淀区',
        contactEmail: 'contact@iot-monitor.com',
        contactPhone: '138-0000-1234',
        website: 'https://www.iot-monitor.com',
        businessModel: '软件即服务(SaaS) + 硬件销售',
        marketSize: '预计市场规模100亿元',
        competitiveAdvantage: '拥有核心算法专利，技术领先同行2-3年',
        financialProjection: '预计3年内实现盈利，年收入达到1亿元',
        riskAssessment: '主要风险：市场竞争加剧、技术迭代风险',
        exitStrategy: '计划5年内IPO或被大型科技公司收购',
        attachments: JSON.stringify([
          'business_plan.pdf',
          'financial_projection.xlsx',
          'patent_certificate.pdf'
        ]),
        tags: JSON.stringify(['人工智能', '物联网', 'SaaS', '智慧城市']),
        status: 'ACTIVE'
      }
    });
